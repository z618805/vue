			...
			<el-form :model="loginForm" :rules="loginRules" ref="loginForm" label-width="0px">
				<el-form-item label="" prop="userName" style="margin-top:40px;">
					<el-row>
						...
						<el-col :span='22'>
							<el-input @keyup.enter.native="submitForm" class="inps" placeholder='用户名' v-model="loginForm.userName"></el-input>
						</el-col>
					</el-row>
				</el-form-item>
				<el-form-item label="" prop="passWord">
					<el-row>
						...
						<el-col :span='22'>
							<el-input @keyup.enter.native="submitForm" show-password class="inps" placeholder='密码' v-model="loginForm.passWord"></el-input>
						</el-col>
					</el-row>
				</el-form-item>
	...
	export default {
		...
		methods: {
			...
			submitForm() {
				...
				this.$http.post(that.$hosh + '/user/login', qs.stringify(params), {
					headers: {
					...
					localStorage.setItem("Id", res.data.data.roleList[0].id);
					localStorage.setItem("name", res.data.data.roleList[0].name);
					that.$router.push({
						path: '/',
					})
				}).catch(function(err) {
